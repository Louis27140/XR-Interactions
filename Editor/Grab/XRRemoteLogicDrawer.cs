...
{
    [CustomPropertyDrawer(typeof(XRRemoteLogicBase), true)]
    public class XRRemoteLogicDrawer : PropertyDrawer
    {
        ...
        private void EnsureTypes()
        {
            ...
            foreach (var t in TypeCache.GetTypesDerivedFrom<XRRemoteLogicBase>())
            {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            // petit espace sous le bloc pour �viter de coller la prop suivante
            return h + v * 2f;
        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            // --- 1) Pr�pare la liste de noms avec "(None)" ----
            string[] displayNames;
